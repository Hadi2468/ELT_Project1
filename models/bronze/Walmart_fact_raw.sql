...
WITH transform_3 AS (
    SELECT 
        ...
        TEMPERATURE,
        FUEL_PRICE,
        NULLIF(MARKDOWN1, 'NA')::NUMBER AS MARKDOWN1,
        NULLIF(MARKDOWN2, 'NA')::NUMBER AS MARKDOWN2,
        NULLIF(MARKDOWN3, 'NA')::NUMBER AS MARKDOWN3,
        NULLIF(MARKDOWN4, 'NA')::NUMBER AS MARKDOWN4,
        NULLIF(MARKDOWN5, 'NA')::NUMBER AS MARKDOWN5,
        CPI,
        UNEMPLOYMENT,
        ISHOLIDAY,
